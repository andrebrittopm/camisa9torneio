-- Atualizar função de verificação (whitelist interna + nomes de colunas corretos + expires_at)
...
BEGIN
    ...
    LOOP
        ...
        v_ttl := COALESCE((v_check->>'ttl_seconds')::INT, 3600); -- Default 1h
        ...
        -- Incluímos expires_at no INSERT
